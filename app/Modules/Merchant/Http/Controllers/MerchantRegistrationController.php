        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\MediaType(
                ...
                schema: new OA\Schema(
                    required: ['full_name', 'phone', 'citizen_id', 'store_name', 'store_address', 'lat', 'lng', 'business_type', 'citizen_id_image', 'store_image'],
                    properties: [
                        ...
                        new OA\Property(property: 'lat', description: 'Vĩ độ của cửa hàng', type: 'number', format: 'float', example: 21.07207),
                        new OA\Property(property: 'lng', description: 'Kinh độ của cửa hàng', type: 'number', format: 'float', example: 105.7739283),
