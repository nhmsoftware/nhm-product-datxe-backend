...
final class VehicleTypeCatalogService
{
    ...
    private const LEGACY_METADATA = [
        1 => [
            ...
            'code' => 'bike',
            'name_vi' => 'Xe Máy',
            'description_vi' => 'Nhanh, tiết kiệm - phù hợp đường ngắn',
            'capacity' => 1,
        ...
        2 => [
            ...
            'code' => 'car_4',
            'name_vi' => 'Ô Tô 4 Chỗ',
            'description_vi' => 'Thoải mái cho 1-3 hành khách',
            'capacity' => 3,
        ...
        3 => [
            ...
            'code' => 'car_7',
            'name_vi' => 'Ô Tô 7 Chỗ ',
            'description_vi' => 'Rộng rãi cho nhóm 4-6 người',
            'capacity' => 6,
        ...
        4 => [
            ...
            'code' => 'car_9',
            'name_vi' => 'Ô Tô 9 Chỗ ',
            'description_vi' => 'Lý tưởng cho nhóm đông hoặc nhiều hành lý',
            'capacity' => 8,
            'estimated_wait_time' => '7-15 phút',
            'service_scopes' => ['city', 'intercity', 'airport'],
            'is_bookable' => true,
            'is_active' => true,
            'sort_order' => 4,
        ...
        5 => [
            'id' => 5,
            'code' => 'car_shared',
            'name_vi' => 'Xe Ghép (Liên tỉnh)',
            'description_vi' => 'Tiết kiệm, đi chung với hành khách khác',
            'capacity' => 1,
            'estimated_wait_time' => 'Theo lịch hẹn',
        ...
        6 => [
            'id' => 6,
            'code' => 'chauffeur',
            'name_vi' => 'Lái hộ (Xe khách)',
            'description_vi' => 'Tài xế lái xe của chính bạn',
            'capacity' => 4,
            'estimated_wait_time' => '10-20 phú',
